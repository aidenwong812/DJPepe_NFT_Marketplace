...
const NFTShowcaseCard: FC<Props> = ({ asset, nftId, name, price }) => {
  ...
  return (
    <Card
      isFooterBlurred
      radius="lg"
      className="flex justify-center items-center border-none p-2 mb-4 bg-slate-500/40"
    >
      <Image
      ...
      />
      <div className="flex flex-col flex-wrap justify-between w-full px-16 py-3">
